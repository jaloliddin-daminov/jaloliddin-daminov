...
const MoviesAddForm = ({addForm}) => {
  ...
  const addFormHandler =  e => {  
    e.preventDefault()
    if(state.name === "" || state.views === "") return alert("malumot kiritilmagan") 
  ...
  return (
    <div className='movies-add-form'>
        ...
        <form className='add-form d-flex' onSubmit={addFormHandler}>
            ...
            <input type="number" className='form-control new-post-label' placeholder="Nechi marotabe ko'rilgan" onChange={changeHandlerInput} name='views' value={state.views} />
